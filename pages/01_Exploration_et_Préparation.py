...
if isCharger2:
    ...
    with exp1:
        st.image(GRAPHS_PATH + 'graph_10.png', width=500)
    ...
    with exp2:
        st.image(GRAPHS_PATH + 'graph_11.png', width=500)
        # sns.set(style='whitegrid')
    ...
    with exp3:
        st.image(GRAPHS_PATH + 'graph_12.png', width=500)
        # sns.set(style='whitegrid')
    ...
    st.image(GRAPHS_PATH + 'graph_14.png', width=500)
